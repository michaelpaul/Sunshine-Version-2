...
public class ForecastFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // avisar a activity que esse fragmento registra menus
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            new FetchWeatherTask().execute("Curitiba,BR");
            return true;
        }
        ...
        */
        ...
        protected String[] doInBackground(String... postCode) {
            ...
            try {
                ...
                Uri apiUri = Uri.parse(FORECAST_BASE_URL)
                        .buildUpon()
            ...
            try {
                ...
                Log.e(LOG_TAG, "onPostExecute: falha no json parse", e);
            }
            return null;
        }
        ...
        protected void onPostExecute(String[] forecastJsonStr) {
            ...
            for (String item : forecastJsonStr) {
